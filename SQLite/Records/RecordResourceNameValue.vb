Friend Class RecordResourceNameValue
  ...
  Private mResourceListItemValue As String
  ...
  Friend Property ListItemID As String
    ...
    Set(value As String)
      If mListItemID <> value Then
        mListItemID = value
        If value IsNot Nothing Then mResourceListItemValue = Nothing
        IsDirty = True
      End If
    End Set
  End Property

  ' Free-text value (used when not lookup-based)
  Friend Property ResourceListItemValue As String
    Get
      Return mResourceListItemValue
    End Get
    Set(value As String)
      If mResourceListItemValue <> value Then
        mResourceListItemValue = value
        If value IsNot Nothing Then mListItemID = Nothing
        IsDirty = True
      End If
    End Set
  End Property
